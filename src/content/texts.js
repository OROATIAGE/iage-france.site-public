export const texts = {
  ...
  "home": {
    ...
    "sectors": {
      ...
      "mobile_nav_sante": "Santé",
      "mobile_nav_agriculture": "Agriculture",
      "mobile_nav_industrie": "Industrie",
      "mobile_nav_gazons": "Gazons",
  ...
  "diagbox": {
    "gazon": {
      ...
      "kits": {
        ...
        "PF000050": {
          "name": "Pathogènes du gazon – Etat global ou Accompagnement plaquage",
      ...
      "qna_reco": {
        ...
        "qna-group-q1_sub1": {
          ...
          "conclusion_text_prefix": "Faites avant tout un audit  de votre pelouse (Diagbox PF 49) par un diagnostic sur les feuilles et les racines : vous aurez ainsi une information sur la présence éventuelle de la pyriculariose, et surtout une évaluation des autres champignons éventuellement présents qui pourraient profiter de vos traitements contre la pyriculariose pour prendre sa place et s'étendre à leur tour.\n\nA partir des périodes de chaleur propices au développement de la pyriculariose, soit à partir de juin ou juillet selon la situation de votre stade, engagez un suivi de détection précoce de la pyriculariose (PF 00011). Cette diagbox est très facile d'emploi : vous passez une lingette sur les lames de la tondeuse après tonte, vous nous l'expédiez avec l'enveloppe prépayée et vous avec le résultat 48h après. \n\nDans la logique d'une détection précose, ce suivi est à mener au minimum une fois pas semaine, et dans les régions à risque 2 fois par semaine : les premiers signes de la pyriculariose apparaissent en effet de l'ordre de 3 jours après un résultat positif de notre Digabox : le suivi rapproché vous permet d'intervenir quand il est encore temps. \n\nVous mettez alors en œuvre les traitements sur la zone identifiée, généralement en plusieurs fois : Vous vérifiez l'effet de chaque traitement avec la Diagbox 00016 qui permet de quantifier la pression du pathogène et sa décroissance au fur et à mesure que les traitements agissent.\n\nLes résultats de l'audit initial vont nous permettre en même temps de vous accompagner dans la mise en place de traitement de prévention contre les autres pathogènes présents.",
          "conclusion_text_suffix": "Les DIAGBOX® recommandées :"
        },
        "qna-group-q1_sub2": {
          "recommendation_text": "",
          "conclusion_text_prefix": "",
