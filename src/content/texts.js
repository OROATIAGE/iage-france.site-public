export const texts = {
  ...
  "diagbox": {
    "gazon": {
      ...
      "ideal_for": {
        "text": "Terrain de football – Terrain de rugby – Terrain de golf – Hippodrome – Terrain de cricket – Terrain de polo – Stade multisports – Parc municipal – Jardin public – Aire de jeux – Cimetière – Espace vert autour d'une école/hôpital/mairie – Campus universitaire – Espace extérieur d'entreprise – Jardin d'hôtel – Centre de congrès – Résidence privée – Accotement végétalisé – Entrée de ville – Rond-point – Gare – Aéroport – Jardin de villa/résidence haut de gamme – Lieu de réception – Pelouse événementielle",
        "title": "Idéal pour"
      },
      "kit_content": {
  ...
  "gazon": {
    "qna": {
      "q1_sub1": "Si la pyriculariose est la maladie la plus répandue dans votre région, ou si vous savez djà que c'est le principal risque, vous pouvez faire une mesure uniquement sur cette cible, pour un coût très limité",
